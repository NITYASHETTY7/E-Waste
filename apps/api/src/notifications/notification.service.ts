    ...
    return this.sendEmail({
      ...
      body: emailLayout(`
        ...
        ${dataTable([
          ...
          [`Pay to Client (${clientName})`, `<strong style="color:#166534;">₹${clientAmount.toLocaleString('en-IN')}</strong>`],
          ['WeConnect Commission (5%)', `<strong style="color:#1e40af;">₹${commissionAmount.toLocaleString('en-IN')}</strong>`],
        ])}
        ${divider}
