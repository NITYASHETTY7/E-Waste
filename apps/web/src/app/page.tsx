            ...
            <div className="relative">
              ...
              {loginDropdownOpen && (
                <div className="absolute top-full right-0 mt-3 w-56 bg-white/90 backdrop-blur-xl border border-[#E2E8F0] dark:border-slate-800 shadow-[0_10px_40px_rgba(0,0,0,0.12)] rounded-xl flex flex-col overflow-hidden z-50 animate-fade-in dark:bg-slate-900/95">
                  ...
                  <button suppressHydrationWarning onMouseDown={() => router.push('/admin')} className="text-left px-5 py-3 text-sm font-bold text-[#4A5568] hover:bg-purple-50 hover:text-purple-600 transition-colors flex items-center gap-3 dark:text-slate-200 dark:hover:bg-purple-950/40 dark:hover:text-purple-400 group">
        ...
        {mobileMenuOpen && (
          <div className="absolute top-full left-4 right-4 mt-2 bg-white/95 backdrop-blur-xl shadow-2xl rounded-2xl py-4 px-6 flex flex-col gap-4 animate-fade-in border border-slate-200/80 dark:bg-slate-900/95 dark:border-slate-800/80 lg:hidden">
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              <button suppressHydrationWarning onClick={() => router.push('/admin')} className="w-full text-left py-3 text-base font-bold text-slate-700 hover:text-purple-600 dark:text-slate-300 dark:hover:text-purple-400 transition-colors">Admin Login</button>
            </div>
          </div>
        )}
      </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {['Home', 'About Us', 'How It Works', 'Services', 'Contact'].map(item => (
                  <li key={item}>
                    <button onClick={() => scrollTo(item === 'About Us' ? 'about' : item.toLowerCase().replace(/ /g, '-'))} className="text-sm hover:text-emerald-400 transition-colors">{item}</button>
                  </li>
                ))}
              </ul>
            </div>
