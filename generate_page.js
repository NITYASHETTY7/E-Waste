...
const tsxContent =       {/* SECTION 1 - HERO */}
...
let s = c.indexOf('{/* SECTION 1 - HERO */}');
if (s === -1) s = c.indexOf('{/* 2. MAIN LAYOUT');
let e = c.indexOf('{/* 8. FOOTER - Minimal */}');
if (e === -1) e = c.indexOf('{/* 9. FOOTER - Minimal */}');

if (s !== -1 && e !== -1) {
  fs.writeFileSync('src/app/page.tsx', c.substring(0, s) + tsxContent + '\n      {/* 8. FOOTER - Minimal */}\n' + c.substring(e + 27));
